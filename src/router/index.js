...
export const asyncRouterMap = [
  {
    ...
    children: [
      {
        path: 'companyList',
        component: () => import('@/views/user/companyList'),
        name: 'companyList',
        meta: {
      ...
      {
        path: 'addCompanyList',
        component: () => import('@/views/user/addCompanyList'),
        name: 'addCompanyList',
        hidden: true,
        meta: {
          perms: ['GET /admin/region/list', 'POST /admin/company/add'],
          title: '新增企业',
          noCache: true
        }
      },
      {
        path: 'addSubsidiary',
        component: () => import('@/views/user/addSubsidiary'),
        name: 'addSubsidiary',
        hidden: true,
        meta: {
          // perms: ['GET /admin/region/list', 'POST /admin/company/update', 'GET /admin/company/read'],
          title: '新增子公司',
          noCache: true
        }
      },
      ...
      
      {
        ...
        component: () => import('@/views/user/lookCompanyList'),
        name: 'addCompanyList',
        hidden: true,
        meta: {
          // perms: ['GET /admin/region/list', 'POST /admin/company/update', 'GET /admin/company/read'],
      ...
      {
        path: 'companyUser',
        component: () => import('@/views/user/companyUser'),
        name: 'companyUser',
        meta: {
          perms: ['GET /admin/company/account/list'],
          title: '企业账号',
          noCache: true
        }
      },
      {
        path: 'addCompanyUser',
        component: () => import('@/views/user/addCompanyUser'),
        name: 'addCompanyUser',
        hidden: true,
        meta: {
          perms: ['GET /admin/company/list', 'POST /admin/company/account/add'],
          title: '新增企业账号',
          noCache: true
        }
      },
      {
        path: 'lookOverInfo',
        component: () => import('@/views/user/lookOverInfo'), //
        name: 'lookOverInfo',
        hidden: true,
        meta: {
          // perms: ['GET /admin/company/list', 'POST /admin/company/account/update', 'GET /admin/company/account/detail'],
          title: '查看企业账号',
          noCache: true
        }
      },
      {
        ...
        component: () => import('@/views/user/editCompanyUser'),
        name: 'addCompanyUser',
        hidden: true,
        meta: {
          perms: ['GET /admin/company/list', 'POST /admin/company/account/update', 'GET /admin/company/account/detail'],
      ...
      },
      {
        ...
        component: () => import('@/views/user/editCompanyUsers'),
        name: 'addCompanyUser',
        hidden: true,
        meta: {
          perms: ['GET /admin/company/list', 'POST /admin/company/account/update', 'GET /admin/company/account/detail'],
      ...
      {
        path: 'addressSetting',
            component: () => import('@/views/user/addressSetting'),
            name: 'addressSetting',
            hidden:true,
            meta: {
              perms: ['GET /admin/address/list'],
  ...
  },
  {
    ...
    children: [
      {
        path: 'list',
        component: () => import('@/views/finance/remitMoneyVerify'),
        name: 'financeList',
        meta: {
          perms: ['GET /admin/finance/remit'],
          title: '对公汇款审核',
          noCache: true
        }
      },
      {
        path: 'handle',
        component: () => import('@/views/finance/handleRemitMoney'),
        name: 'financeHandle',
        meta: {
          perms: ['GET /admin/finance/handle', 'POST /admin/finance/handle', 'POST /admin/finance/handle'],
          title: '审核',
          noCache: true
        },
        hidden: true
      ...
      {
        path: 'show',
        component: () => import('@/views/finance/showRemitMoney'),
        name: 'financeShow',
        meta: {
          perms: ['GET /admin/finance/show', 'POST /admin/finance/show', 'POST /admin/finance/show'],
          title: '查看',
          noCache: true
        },
        hidden: true
...

  {
    ...
    children: [
      ...
      {
        path: 'scope',
        component: () => import('@/views/config/scope'),
        name: 'configScope',
        meta: {
          perms: ['GET /admin/config/scope', 'POST /admin/config/scope'],
          title: '配送范围设置',
          noCache: true
        }
      },
...

  {
    ...
    children: [
      ...
      {
        path: 'join',
        component: () => import('@/views/stat/joins'),
        name: 'statJoins',
        meta: {
          perms: ['GET /admin/stat/joins'],
          title: '入驻统计',
          noCache: true
        }
      }
