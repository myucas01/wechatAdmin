...
<!-- 新增 -->
          ...
          <div class="buyWay">
            ...
            <el-row>
              <el-col :span="8"><div class="grid-content">
                <el-form-item label="集采价"> <el-input :disabled="radioWay==1?false:true" v-model="goods.price" placeholder="请设置企业集采价格"></el-input> </el-form-item>
              </div></el-col>
              <el-col :span="8"><div class="grid-content">
                <el-form-item label="集采起订单量"> <el-input :disabled="radioWay==1?false:true" v-model="goods.orderSize" placeholder="请设置企业集采起订量"></el-input> </el-form-item>
              </div></el-col>
            </el-row>
          </div>
          <div class="buyWay">
            ...
            <el-row>
              <el-col :span="8"><div class="grid-content">
                <el-form-item label="会员价"> <el-input :disabled="radioWay==2?false:true" v-model="goods.memberPrice" placeholder="请设置会员购买价格"></el-input> </el-form-item>
              </div></el-col>
              <el-col :span="8"><div class="grid-content">
                <el-form-item label="会员起定量"> <el-input :disabled="radioWay==2?false:true" v-model="goods.minimumSize" placeholder="请设置会员购买起订量"></el-input> </el-form-item>
              </div></el-col>
              <el-col :span="8"><div class="grid-content grid-content-orderSize">
                <el-form-item label="会员限购数"> <el-input :disabled="radioWay==2?false:true" v-model="goods.purchase" placeholder="请设置会员限购数"></el-input> </el-form-item>
                <p class="orderSize" v-show="goods.purchase < goods.minimumSize">限购数不可小于起订量</p>
              </div></el-col>
            </el-row>
          </div>
        </el-form-item> -->
        ...
        <el-form-item label="购买方式" prop="goodsSn">
          <div class="buyWay">
            ...
            <el-row>
              <el-col :span="8"><div class="grid-content">
                <el-form-item label="集采价"><el-input v-model="goods.price" :disabled="!radioWay1" placeholder="请设置企业集采价格"></el-input> </el-form-item>
              </div></el-col>
              <el-col :span="8"><div class="grid-content">
                <el-form-item label="集采起订单量"> <el-input type="number" autocomplete="off" :disabled="!radioWay1" v-model="goods.orderSize" placeholder="请设置企业集采起订量"></el-input> </el-form-item>
              </div></el-col>
            </el-row>
          </div>
          <div class="buyWay">
            ...
            <el-row>
              <el-col :span="8"><div class="grid-content">
                <el-form-item label="会员价"> <el-input type="number" :disabled="!radioWay2" v-model="goods.memberPrice" placeholder="请设置会员购买价格"></el-input> </el-form-item>
              </div></el-col>
              <el-col :span="8"><div class="grid-content">
                <el-form-item label="会员起定量"> <el-input type="number" :disabled="!radioWay2" v-model="goods.minimumSize" placeholder="请设置会员购买起订量"></el-input> </el-form-item>
              </div></el-col>
              <el-col :span="8"><div class="grid-content grid-content-orderSize">
                <el-form-item label="会员限购数"> <el-input type="number" :disabled="!radioWay2" v-model="goods.purchase" placeholder="请设置会员限购数"></el-input> </el-form-item>
                <p class="orderSize" v-show="Number(goods.purchase) < Number(goods.minimumSize)">限购数不可小于起订量</p>
              </div></el-col>
            </el-row>
          </div>
        </el-form-item>
        ...
        <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
         <el-form-item label="物流配送" prop="goodsSn">
           <el-radio v-model="radioLogistics" label="1">厂家直送</el-radio>
           <el-radio v-model="radioLogistics" label="2">物流配送</el-radio>
         </el-form-item>
    ...
    <el-card class="box-card">
      ...
      <el-dialog :visible.sync="productVisiable" title="设置货品">
        <el-form
          ...
          <el-form-item v-if="radioWay1" label="货品售价" prop="price">
            <el-input :disabled="radioWay1" v-model="goods.price"/>
            <!-- <el-input v-else v-model="productForm.price"/> -->
          </el-form-item>

          <el-form-item v-if="radioWay2" label="会员售价" prop="price">
            <el-input :disabled="radioWay2" v-model="goods.memberPrice"/> 
            <!-- {{memberPrice}} -->
          </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      categoryList: [],
      brandList: [],
      goods: { picUrl: '', gallery: [],purchaseWay:[] },
      specVisiable: false,
      specForm: { specification: '', value: '', picUrl: '' },
      multipleSpec: false,
      specifications: [{ specification: '规格', value: '标准', picUrl: '' }],
      productVisiable: false,
      productForm: { id: 0, specifications: [], number: 0, url: ''},
      products: [{ id: 0, specifications: ['标准'], number: 0, url: '',price: 0,memberPrice: 0 }],
  ...
  computed: {
    ...
    // price_rules(){
    //   return this.products.price = this.goods.price
    // },
    // memberPrice_rules(){
    //   return this.products.memberPrice = this.goods.memberPrice
    // }
  },
  created() {
    this.init()
    // this.price_rules()
    // this.memberPrice_rules()
  },
  watch:{
    goods(newData,oldData){ // 价格赋值到 配置价格 
      console.log(newData)
      console.log(this.products[0].price,this.products[0].memberPrice)
        this.products[0].price = newData.price
        this.products[0].memberPrice = newData.memberPrice
        this.goods.collectPrice = newData.price
    },
    radioWay1(newData,oldData){
      if(!newData){
        delete this.goods.price
        delete this.goods.orderSize
        if(this.radioWay2){
    ...
    radioWay2(newData,oldData){
      if(!newData){
        ...
        delete this.goods.minimumSize
        delete this.goods.purchase
        if(this.radioWay1){
  ...
  methods: {
    ...
    handlePublish: function() {
      if(!this.radioWay1&&!this.radioWay2){ // 如果未选择复选框 购买方式 不提交
        MessageBox.alert('请选择购买方式!', {
      ...
      // }
      // this.radioWay1?  this.goods.ispurchaseWay
      if(this.radioWay1 && this.radioWay2){
        this.goods.purchaseWay = 3;
      }else if(this.radioWay1){
        this.goods.purchaseWay = 1;
      }else if(this.radioWay2){
        this.goods.purchaseWay = 2;
      }
      const finalGoods = {
        goods: this.goods,
