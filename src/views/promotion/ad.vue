        ...
        <el-form-item label="广告图片" prop="url">
          <el-upload
            ...
            <div slot="tip" class="el-upload__tip">
              <p style="margin: 0;line-height: 22px;color: #777;">图片尺寸：1440px * 800px</p>
              <p style="margin: 0;line-height: 22px;color: #777;">图片格式：只能上传jpg/png文件</p>
              <p style="margin: 0;line-height: 22px;color: #777;">图片大小：建议500KB以下，最好不超过1024KB</p>
            </div>
          </el-upload>
        </el-form-item>
