          ...
          >
            ...
            <!-- <el-form-item label="所属企业: " prop="parentCompany" style="width:75%">
             ...
             <el-form-item label="归属企业" prop="parentCompany" style="width:75%">
              <el-select style="width: 100%;"  ref="parentCompany" v-model="ruleForm.companyName" :remote-method="remoteMethod" :loading="loading"
                remote @change="handleCompany" reserve-keyword filterable placeholder="请选择归属企业">
          ...
          if (res.data.errno == 0) {
            ...
            companyList(this.listQuery).then(response => {
              ...
              this.list.forEach(item => {
                if (item.value == this.ruleForm.parentCompany) {
                  this.options = item
