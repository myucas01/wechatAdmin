  ...
  <div class="app-container">
    <div class="appBox">
      <el-scrollbar style="height: 100%;">
        <div class="appWrap">
          <p class="appTitle">编辑和新增</p>
          <p>基础信息</p>
          <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="150px" class="demo-ruleForm">

            <el-form-item label="企业名称" prop="company_name">
              <el-input v-model="ruleForm.company_name" placeholder="请填写企业名称" />
            </el-form-item>

            <el-form-item label="企业联系人" prop="company_linkman">
              <el-input v-model="ruleForm.company_linkman" placeholder="请填写企业联系人姓名" />
            </el-form-item>

            <el-form-item label="联系方式" prop="company_phone">
              <el-input v-model="ruleForm.company_phone" placeholder="请填写企业联系人的联系方式" />
            </el-form-item>
          ...
          <!--子公司信息  新增页面不显示-->
           <div v-if="this.$route.path == '/user/editCompanyList'" class="SubsidiaryDetail">
              <div class="sections_title">
                  <span class="detail">子公司信息</span> <el-button @click="addSubsidiary" type="primary" style="color:#fff;"> + 添加子公司 </el-button>
              </div>
          </div>
          <Subsidiary-detail v-if="this.$route.path == '/user/editCompanyList'"/> 
        </div>
      </el-scrollbar>
...
<script>
  import { regionClist, companyAdd, companyRead, companyEdit,companySonList } from '@/api/user' 
  ...
  export default {
    ...
    methods: {
      ...
      addSubsidiary(){ // 跳转到添加子公司
        this.$router.push({
          path:'/user/addSubsidiary',
          query:{company_ids:this.company_ids}
        })
      },
      companyRead() {
        const res = companyRead({
          ...
          .then(res => {
            if (res.data.errno == 0) {
              ...
              this.company_ids = res.data.data.company_id; // pid  创建子公司的时候需要个个id
