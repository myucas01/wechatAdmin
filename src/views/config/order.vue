<template>
  <div class="app-container">
    <el-form ref="dataForm" :model="dataForm" status-icon label-width="300px">
      <el-form-item label="企业账号下单后超时" prop="litemall_order_unpaid">
        <el-input v-model="dataForm.litemall_order_uncompany" class="input-width">
      ...
      <el-form-item label="交易完成后超期" prop="litemall_order_comment">
        <el-input v-model="dataForm.litemall_order_dealok" class="input-width">
          <template slot="append">天</template>
        </el-input>
        <span class="info">未退货则可开票</span>
      </el-form-item>
      <el-form-item>
